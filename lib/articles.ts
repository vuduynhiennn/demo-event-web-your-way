...
export const articles: Article[] = [
  {
    ...
    views: 1200,
    content:
      "Trường Đại học Mở Hà Nội là cơ sở giáo dục đại học công lập hàng đầu với hơn 30 năm phát triển, cung cấp cơ hội học tập cho mọi người và tỷ lệ việc làm sau tốt nghiệp trên 90%. Với quy mô đào tạo khoảng 35.000 sinh viên, trường khẳng định vai trò tiên phong trong cung cấp các chương trình đào tạo đáp ứng nhu cầu xã hội hiện đại.",
  },
  {
    ...
    views: 980,
    content:
      "Khám phá các ngành học như Thiết kế đồ họa, Công nghệ thông tin, Quản trị kinh doanh, Luật, Ngôn ngữ Anh... đáp ứng nhu cầu xã hội hiện đại. Các ngành bao gồm: Thiết kế đồ họa, Công nghệ thông tin, Quản trị kinh doanh, Luật, Ngôn ngữ Anh.",
  },
  {
