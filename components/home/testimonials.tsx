      ...
      <div className="container">
        <div className="flex flex-col items-center text-center mb-12">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Hear From Our Students</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Discover how our programs have transformed the lives and careers of our graduates.
            </p>
          </motion.div>
        </div>
